...
_diff = [_mine,_val,oev_carryWeight,oev_maxWeight] call OEC_fnc_calWeightDiff;
...
if(([true,_mine,_diff] call OEC_fnc_handleInv)) then
{
	_itemName = [([_mine,0] call OEC_fnc_varHandle)] call OEC_fnc_varToStr;
	titleText[format[localize "STR_ISTR_Pick_Success",_itemName,_diff],"PLAIN DOWN"];
};
