...
//	Description: Checks what shop it is and sometimes the vehicle to determine whether or not they have the license.
...
switch (life_veh_shop select 0) do {
	...
	case "med_ship": {_ret = license_med_cg;};
	case "civ_car": {_ret = license_civ_driver;};
	case "indp_news": {_ret = true;};
	case "civ_ship": {_ret = license_civ_boat;};
	case "civ_air": {_ret = license_civ_air;};
	case "civ_plane": {_ret = license_civ_air;};
	case "civ_kart": {_ret = license_civ_driver;};
	case "cop_plane": {_ret = license_cop_air;};
	...
	case "war_v": {_ret = license_civ_rebel;};
	case "reb_boat": {_ret = license_civ_rebel;};
	case "cop_car": {_ret = true;};
	case "vigi_car": {_ret = license_civ_vigilante;};
	case "cop_ship": {
