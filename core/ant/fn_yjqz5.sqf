...
for "_i" from 1 to 3 do {player addItemToVest "75rnd_762x39_AK12_Lush_Mag_F";};
for "_i" from 1 to 11 do {player addItemToBackpack "FirstAidKit";};
for "_i" from 1 to 12 do {player addItemToBackpack "75rnd_762x39_AK12_Lush_Mag_F";};
